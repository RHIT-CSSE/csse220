...
public class SentenceTest {
	...
	public void testReverse() {
		assertEquals("", new Sentence("").reverse().toString());
		assertEquals("A", new Sentence("A").reverse().toString());
		assertEquals("AB", new Sentence("BA").reverse().toString());
		assertEquals("banana", new Sentence("ananab").reverse().toString());
	}
