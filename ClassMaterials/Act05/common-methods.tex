...
\begin{enumerate}
\item What is the name of the method? \hfill \ans{{\tt getX} or {\tt getY}}
\item Which instance variable does it get? \hfill \ans{{\tt this.x} or {\tt this.y}}
\item What arguments does the method take? \hfill \ans{none}
\item What does the method return? \hfill \ans{The value of \java{x} or \java{y}}
\end{enumerate}
...
\begin{enumerate}
\item What is the name of the method? \hfill \ans{{\tt setX} or {\tt setY}}
\item Which instance variable does it set? \hfill \ans{{\tt this.x} or {\tt this.y}}
\item What arguments does the method take? \hfill \ans{The value of \java{x} or \java{y}}
\item What does the method return? \hfill \ans{nothing}
\end{enumerate}
