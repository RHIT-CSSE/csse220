...
\item \java{black == other} \hfill \ans{false}
\item \java{black == gold} \hfill \ans{false}
\item \java{black.toString()} \hfill \ans{"\#000000"}
\item \java{black.equals(other)} \hfill \ans{true}
\item \java{black.equals(gold)} \hfill \ans{false}
\item \java{gold.toString()} \hfill \ans{"\#ffd700"}
\end{enumerate}
\end{multicols}
...
\setlength{\defaultwidth}{5em}
\begin{enumerate}[itemsep=1pt]
\item \java{p1 == p2} \hfill  \ans{false}
\item \java{p1.toString()} \hfill \ans{"(0, 0)"}
\item \java{p3.toString()} \hfill \ans{"(3, 3)"}
\item \java{p1.equals(p2)} \hfill \ans{true}
\item \java{p1.equals("(0, 0)")} \hfill \ans{false}
\item \java{p3.equals("(3, 3)")} \hfill \ans{false}
\end{enumerate}
\end{multicols}
