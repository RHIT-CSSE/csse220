...
/**
 * Driver class containing main for running and testing Collections.sort on the
 * Rectangle class
 * 
 * @author CSSE Faculty
 *
...
public class RectangleDriver {
	...
	private void runApp() {
		...
		// TODO #1 - uncomment the following line, then go to Rectangle.java and do TODO
		// #2
		...
		// which should sort by non-increasing perimeter (decreasing or neural)
		...
		// TODO #4 - declare a variable called reversePerimeterComparator using type
		// Comparator<Rectangle>,
		// make it sort by NON-DECREASING perimeter. (increasing or neutral)
		// Then uncomment the following line
		Comparator<Rectangle> reversePerimeterComparator = new Comparator<Rectangle>() {
