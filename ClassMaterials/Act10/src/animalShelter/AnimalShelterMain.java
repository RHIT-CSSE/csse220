...
/**
 * Class representing a small local animal shelter serving cats and dogs. 
 * 
...
public class AnimalShelterMain {
    ...
    public void handleCommand(String command, Scanner scanner) {
        if (command.equals("add animal")) {
            ...
            System.out.print("Enter animal species (dog or cat): ");
            String species = scanner.nextLine();
            boolean isValidSpecies = false;
            while (species.trim().isEmpty() || !isValidSpecies) {
                System.out.print("Invalid entry. Enter animal species (dog or cat): ");
                species = scanner.nextLine().toLowerCase();
                isValidSpecies = species.equals("dog") || species.equals("cat");
            }
            
            Animal newAnimal;
            if (species.equals("cat")) {
                boolean isLitterBoxTrained = false;
                // TODO: prompt for litter box training status
                newAnimal = new Cat();
            } else { // it must be that species is "dog"
                // TODO: prompt for house broken status, daily walking miles
                newAnimal = new Dog();
            }
    ...
    public static void main(String[] args) {
        ...
        Animal fido = new Dog(31516, "Fido", 2022, 3, true, 2.4);
        Animal mittens = new Cat(54321, "Mittens", 2024, 11, false);
