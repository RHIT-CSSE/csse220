...
public class BinarySearch {
	...
	public static void main(String[] args) {
		...
		int n = 10; // Try increasing n from 10 up to 100,000,000
	...
	public static <E extends Comparable<E>> int binarySearch(E[] array, E value) {
		...
		return binarySearchHelper(array, value, 0, n);
	}
	 ...
	 *         be inserted if it doesn't appear in the array
	 */
	private static <E extends Comparable<E>> int binarySearchHelper(E[] array, E value,
                                                                    int low, int high) {
		if (low >= high) {
			return low;
		}
		...
		if (compareResult == 0) {
			...
			// search lower half
			return binarySearchHelper(array, value, low, low + halfSize);
		} else {
			// search upper half
			return binarySearchHelper(array, value, low + halfSize + 1, high);
		}
	}
