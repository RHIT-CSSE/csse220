...
public class Main {
	...
	public Main() {
		...
		// 4. Add this listener.
		// 5. Tie in the raindrop class (other class)
		...
		//	advanceListener.advanceOneTick();
			...
			// NOTE: Could try to insert a big for loop here to slow 
			// the processor enough to see the square.
