...
/**
 * Represents a solar system with planets and moons, initialized with data from our solar system.
 * <br>
 * Supports animation.
 */
public class SolarSystem {
    ...
    private void initializePlanets() {
        planets.add(new Planet("Mercury", new Color(169, 169, 169), 80, 0.02, 8));
        planets.add(new Planet("Venus", new Color(255, 198, 73), 110, 0.015, 12));
    ...
    public void drawAll(Graphics graphics) {
        ...
        int sunRadius = 10;
        int sunX = SolarSystemMain.DEFAULT_FRAME_WIDTH / 2 - sunRadius;
        int sunY = SolarSystemMain.DEFAULT_FRAME_HEIGHT / 2 - sunRadius;
        graphics.fillOval(sunX, sunY, 2 * sunRadius, 2 * sunRadius);
