...
public class TestArrayListSummation {
	...
	public void testArrayListSummation01() {
		...
		assertEquals(6, HWRecursionPart1.arrayListSummation(values));
		testsPassed++;
	...
	public void testArrayListSummation02() {
		...
		assertEquals(46, HWRecursionPart1.arrayListSummation(values));
		testsPassed++;
	...
	public void testArrayListSummation03() {
		...
		assertEquals(71, HWRecursionPart1.arrayListSummation(values));
		testsPassed++;
	...
	public void testArrayListSummation04() {
		...
		assertEquals(20071, HWRecursionPart1.arrayListSummation(values));
		testsPassed++;
	...
	public void testArrayListSummation05() {
		...
		assertEquals(20000, HWRecursionPart1.arrayListSummation(values));
		testsPassed++;
