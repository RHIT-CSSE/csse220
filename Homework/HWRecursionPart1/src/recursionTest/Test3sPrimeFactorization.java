...
public class Test3sPrimeFactorization {
	...
	public void test3sPrimeFactorization01() {
		numberOfTests++;
		assertEquals(1, HWRecursionPart1.countNumberOf3sInPrimeFactorization(3));
		testsPassed++;
	...
	public void test3sPrimeFactorization02() {
		numberOfTests++;
		assertEquals(2, HWRecursionPart1.countNumberOf3sInPrimeFactorization(9));
		testsPassed++;
	...
	public void test3sPrimeFactorization03() {
		numberOfTests++;
		assertEquals(0, HWRecursionPart1.countNumberOf3sInPrimeFactorization(412));
		testsPassed++;
	...
	public void test3sPrimeFactorization04() {
		numberOfTests++;
		assertEquals(0, HWRecursionPart1.countNumberOf3sInPrimeFactorization(0));
		testsPassed++;
	...
	public void test3sPrimeFactorization05() {
		numberOfTests++;
		assertEquals(0, HWRecursionPart1.countNumberOf3sInPrimeFactorization(7675489));
		testsPassed++;
	...
	public void test3sPrimeFactorization06() {
		numberOfTests++;
		assertEquals(4, HWRecursionPart1.countNumberOf3sInPrimeFactorization(234516789));
		testsPassed++;
	...
	public void test3sPrimeFactorization07() {
		numberOfTests++;
		assertEquals(15, HWRecursionPart1.countNumberOf3sInPrimeFactorization(14348907));
		testsPassed++;
