...
public class TestCompoundInterest {
	...
	public void testCompoundInterest01() {
		...
		double actual = HWRecursionPart2.compoundInterest(1000.0, 6.0, 12);
	...
	public void testCompoundInterest02() {
		...
		double actual = HWRecursionPart2.compoundInterest(5000.0, 4.8, 24);
	...
	public void testCompoundInterest03_zeroMonths() {
		...
		double actual = HWRecursionPart2.compoundInterest(1000.0, 5.0, 0);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
	...
	public void testCompoundInterest04_zeroRate() {
		...
		double actual = HWRecursionPart2.compoundInterest(2000.0, 0.0, 24);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
	...
	public void testCompoundInterest05_negativeRate() {
		...
		double actual = HWRecursionPart2.compoundInterest(1000.0, -1.0, 24);
	...
	public void testCompoundInterest07_largeValues() {
		...
		double actual = HWRecursionPart2.compoundInterest(1000000.0, 6.0, 12);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
	...
	public void testCompoundInterest08() {
		...
		double actual = HWRecursionPart2.compoundInterest(100.0, 8.4, 6);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
	...
	public void testCompoundInterest09_zeroPrincipal() {
		numberOfTests++;
		double expected = 0.0;
		double actual = HWRecursionPart2.compoundInterest(0.0, 5.0, 12);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
	...
	public void testCompoundInterest10_highRateShortTerm() {
		...
		double actual = HWRecursionPart2.compoundInterest(1000.0, 60.0, 1);
		assertEquals(expected, actual, DELTA);
		testsPassed++;
