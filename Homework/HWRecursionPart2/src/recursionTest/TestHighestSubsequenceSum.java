...
public class TestHighestSubsequenceSum {
	...
	public void testHighestSubsequenceSum01() {
		...
		numberOfTests++;
		assertEquals(13, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
	...
	public void testHighestSubsequenceSum02() {
		...
		numberOfTests++;
		assertEquals(10, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
	...
	public void testHighestSubsequenceSum03() {
		...
		numberOfTests++;
		assertEquals(1, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
	...
	public void testHighestSubsequenceSum04() {
		...
		numberOfTests++;
		assertEquals(19, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
	...
	public void testHighestSubsequenceSum05() {
		...
		numberOfTests++;
		assertEquals(15, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
	...
	public void testHighestSubsequenceSum06() {
		int[] testInput = new int[] { -1, -2, -3, -4, -10, 5, 6, -3, -7, -20, -2, -3 };
		numberOfTests++;
		assertEquals(11, HWRecursionPart2.highestSubsequenceSum(testInput));
		testsPassed++;
