...
public class TestGetTemperatureDropCity {
	...
	public void testGetTemperatureDropCityN01() {
		...
		numberOfTests++;
		assertEquals("la", HWMaps.getTemperatureDropCity(temp1, city1));
		testsPassed++;
	...
	public void testGetTemperatureDropCityN02() {
		...
		numberOfTests++;
		assertEquals(null, HWMaps.getTemperatureDropCity(temp2, city2));
		testsPassed++;
	...
	public void testGetTemperatureDropCityN03() {
		...
		numberOfTests++;
		assertEquals("ny", HWMaps.getTemperatureDropCity(temp3, city3));
		testsPassed++;
