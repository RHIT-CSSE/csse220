...
public class TestTimesOccur {
	...
	public void testTimesOccurN01() {
		...
		int[] f = { 4, 7, 2 };
		int[] h = { 4, 7, 2, 1, 8 };
		assertEquals(1, HWMaps.timesOccur(f, h));
		testsPassed++;
	}
	...
	public void testTimesOccurN02() {
		...
		int[] a = { 7, 1, 1, 7, 7, 1, 1 };
		int[] b = { 1, 1 };
		assertEquals(2, HWMaps.timesOccur(b, a));
		testsPassed++;
	}
	...
	public void testTimesOccurN03() {
		...
		int[] b = { 1, 1 };
		int[] c = { 1, 1, 1, 3 };
		assertEquals(2, HWMaps.timesOccur(b, c));
		testsPassed++;
	}
	...
	public void testTimesOccurN04() {
		...
		int[] b = { 1, 1 };
		int[] d = { 1, 3, 4, 1, 2, 1 };
		assertEquals(0, HWMaps.timesOccur(b, d));
		testsPassed++;
	}
	...
	public void testTimesOccurN05() {
		...
		int[] c = { 1, 1, 1, 3 };
		int[] d = { 1, 3, 4, 1, 2, 1 };
		assertEquals(0, HWMaps.timesOccur(c, d));
		testsPassed++;
	}
	...
	public void testTimesOccurN06() {
		...
		int[] f = { 4, 7, 2 };
		assertEquals(3, HWMaps.timesOccur(f, e));
		testsPassed++;
	}
	...
	public void testTimesOccurN07() {
		...
		int[] e = { 4, 7, 2, 1, 8, 4, 7, 2, 0, 8, 4, 7, 2, 1, 8 };
		int[] g = { 4, 7, 2, 1 };
		assertEquals(2, HWMaps.timesOccur(g, e));
		testsPassed++;
	}
	...
	public void testTimesOccurN08() {
		...
		int[] e = { 4, 7, 2, 1, 8, 4, 7, 2, 0, 8, 4, 7, 2, 1, 8 };
		int[] h = { 4, 7, 2, 1, 8 };
		assertEquals(2, HWMaps.timesOccur(h, e));
		testsPassed++;
	}
	...
	public void testTimesOccurN09() {
		...
		int[] a = { 7, 1, 1, 7, 7, 1, 1 };
		int[] h = { 4, 7, 2, 1, 8 };
		assertEquals(0, HWMaps.timesOccur(h, a));
		testsPassed++;
	}
}
