...
public class TestPowerOfThree {
	...
	public void testPowerOfThree01() {
		numberOfTests++;
		assertEquals(true, HW8.evenPowerOfThree(1));
		testsPassed++;
	} // testPowerOfThree01
	...
	public void testPowerOfThree02() {
		numberOfTests++;
		assertEquals(false, HW8.evenPowerOfThree(3));
		testsPassed++;
	} // testPowerOfThree02
	...
	public void testPowerOfThree03() {
		numberOfTests++;
		assertEquals(true, HW8.evenPowerOfThree(9));
		testsPassed++;
	} // testPowerOfThree03
	...
	public void testPowerOfThree04() {
		numberOfTests++;
		assertEquals(false, HW8.evenPowerOfThree(14348907));
		testsPassed++;
	} // testPowerOfThree04
	...
	public void testPowerOfThree05() {
		numberOfTests++;
		assertEquals(true, HW8.evenPowerOfThree(4782969));
		testsPassed++;
	} // testPowerOfThree05
	...
	public void testPowerOfThree06() {
		numberOfTests++;
		assertEquals(true, HW8.evenPowerOfThree(729));
		testsPassed++;
	} // testPowerOfThree06
	...
	public void testPowerOfThree07() {
		numberOfTests++;
		assertEquals(false, HW8.evenPowerOfThree(2187));
		testsPassed++;
	} // testPowerOfThree07
