...
public class ResponsiveCarViewer {
	...
	private void setUpViewer() {
		...
		// TODO #1: Add a Keystroke Handler to this.frame
		...
		//////////////////////
		// Part 1
		KeystrokeHandler keystrokeHandler = new KeystrokeHandler(component);		
		// Important piece of advice: add Key Listener to the frame
		this.frame.addKeyListener(keystrokeHandler);	
		//////////////////////
		
		
		// TODO #2: Modify Keystroke Handler from #1
		// Make car move when the space bar is typed
		
		// TODO #3: Modify what gets drawn
		...
		// This trail needs to be persistent, i.e., you should be able to see the line from where car
		// starts and finally ends up after all turns and moves have been processed
