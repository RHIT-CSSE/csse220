...
public class CarComponent extends JComponent {
	...
	protected void paintComponent(Graphics g) {
		...
		// TODO Part 1
		// 
		// For the Car class, add remaining body part, windows, tires, and head light
		// -----
		Car car1 = new Car();
		car1.drawOn(g2);
		...
		Car blueCar = new Car(Color.BLUE, 1.25, 150, 275);
		blueCar.drawOn(g2);
		System.out.println("blueCar: " + blueCar);
		Car orangeCar = new Car(Color.ORANGE, 0.75, 400, 275);
		orangeCar.drawOn(g2);
		System.out.println("orangeCar: " + orangeCar);
		Car greenCar = new Car(Color.GREEN, 0.25, 550, 275);
		greenCar.drawOn(g2);
		...
		//
		// Part 3 - Create and draw 9 cars - these cars will be in drawn in various flipped positions
		//			(1) Color = MAGENTA
		...
		for (int k = 0, z = 9; k < z; k++) {
			double rotationFactor = (k * (0.25) * Math.PI);
			Car stuntCar = new Car(Color.MAGENTA, 0.50, (k * 100) + 100, 450);
			stuntCar.setRotationFactor(rotationFactor);
			stuntCar.drawOn(g2);
		} // end for			
	} // paintComponent
